  ...
  <div class="wrapper-mid">
    ...
    <div id="paper">
      ...
      <div id="paper-mid">
        <div class="entry">
          <!-- Begin Image -->
          <img class="portrait" src="img/p3.jpg" alt="rayan" />
          <!-- End Image -->
          <!-- Begin Personal Information -->
          <div class="self">
            <h1 class="name">Pramudhitha Chamikara<br /><br></h1>
            <ul>
              <li class="ad">No 316,"Awase Gedara" , Kabillewela South, Bandarawela, SriLanka.</li><br>
              <li class="mail">pramudithachamikara@gmail.com</li>
              <li class="tel">+94 71 99 39 729</li>
              <li class="web">www.Silentgeeks.com</li>
            </ul>
          </div>
          ...
          <!-- <div class="social">
            <ul>
              ...
              <li><a class='north' href="#" title="My Facebook Profile"><img src="images/icn-facebook.jpg" alt="" /></a></li> </ul>
          </div> -->
          <!-- End Social -->
        </div>
        <!-- Begin 1st Row -->
        ...
        <div class="entry">
          <h2>EDUCATION</h2>
          <div class="content">
            <h3>Jan 1999 - Jan 2010</h3>
            <p>Dharmashoka Central College, Bandarawela. <br />
              <em>O/L Eaxamination</em></p>
          </div>
		  
		   <div class="content">
		   <h3>May 2010 - Sep 2012</h3>
            <p>Bandarawela Maha Vidyalaya, Embilipitiya. <br />
              <em>A/L Eaxamination</em></p>
          </div>
          ...
          <div class="content">
            ...
            <p>University of Jaffna,  Sri Lanka. <br />
              <em>Bachelor of Science Honours in Computer Science(currently 3rd year undergraduate)</em></p>
          </div>
        </div>
        <!-- End 2nd Row -->
        <!-- Begin 3rd Row -->
        ...
        <div class="entry">
          ...
          <div class="content">
		   ...
		   <div class="content">
            ...
            <p>
              Hacker Rank (https://www.hackerrank.com/ChamiTDP)<br>
             
              git hub(https://github.com/ChamikaraTDP)<br>
			  2nd year software engineer project<br>
            </p>
          </div>
