    ...
    <div id="paper">
      ...
      <div id="paper-mid">
        <div class="entry">
          ...
          <div class="self">
            <h1 class="name">A.G.D.D.U. Gunawardhana <br /><br>

              <span>Interactive Designer</span></h1>
            <ul>
              <li class="ad">No.346/6, 6th cannel, Moraketiya, Embilipitiya, SriLanka.</li><br>
              <li class="mail">gunawadhanaudara@gmail.com</li>
              <li class="tel">+94 71 73 78 668</li>
        ...
        <div class="entry">
          ...
          <div class="content">
            ...
            <p>University of Jaffna,  Sri Lanka. <br />
              <em>Bachelor of Science Honours in Computer Science</em></p>
          </div>
        </div>
        <!-- End 2nd Row -->
        <!-- Begin 3rd Row -->
